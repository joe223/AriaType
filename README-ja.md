...
> [!TIP]
> **v0.5 の新機能 (2026-05-07)**
> - **ウィンドウコンテキストキャプチャ** – OCR による画面認識でより正確な文章整形
> - **パフォーマンス向上** – より速いテキスト挿入とスムーズな UI
> - **オンボーディング改善** – より分かりやすい初回ガイド
...
- クラウド STT 設定は [クラウド STT 設定ガイド](https://github.com/joe223/AriaType/discussions/3) 参照 – API Key でより強力な認識を有効化。
